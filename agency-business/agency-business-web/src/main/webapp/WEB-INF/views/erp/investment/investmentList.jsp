	...
	<head>
		...
		<script type="text/javascript">
	        ...
	        function add() {
				...
				//设置对话框标题	        	
	            $("#dlg").dialog("open").dialog('setTitle', '新增出资方信息');
	            url = "${pageContext.request.contextPath}/erp/investment/addMerchant";
	        }
	        ...
	        function edit() {
	            ...
	            if (row) {
	            	//设置对话框标题
	        		$("#dlg").dialog("open").dialog('setTitle', '修改出资方信息');
	        	
	            	//加载要修改的记录，用于初始化页面表单元素
                    $("#fm").form("load", "${pageContext.request.contextPath}/erp/investment/editMerchantForm/" + row.merchantCode);
                    
                    url = "${pageContext.request.contextPath}/erp/investment/editMerchant";
	            } else {
	            	$.messager.show({
	                    title: '提示',
	                    msg: "请选择一条记录！"
    ...
    <body class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'north',border:false">
			...
			<div id="toolbar">
				<table class="query">
					<tr>
						<td style="white-space: nowrap;">出资方编码</td>
						<td><input id="merchantCodeSearch" name="merchantCodeSearch"  /></td>
						<td style="white-space: nowrap;">出资方名称</td>
		...
		<div data-options="region:'center',border:false">
		    ...
		    <table id="dg" fit="true" class="easyui-datagrid" title="" style="width:'1024px';height:auto" 
			    ...
			    fitColumns:true,
			    toolbar: '#tb',
			    url: '${pageContext.request.contextPath}/erp/investment/findAllMerchant',
			    onClickCell:onClickCell
			    ">
			    <thead>
				    <tr>
				    	<th data-options="field:'merchantCode',width:200">出资方编码</th>
				    	<th data-options="field:'merchantName',width:200">出资方名称</th>
					    ...
					    <th data-options="field:'maxAmount',width:100">资金池最高限额</th>
			...
			<div id="dlg" class="easyui-dialog" style="width: 450px; height: 300px; padding: 10px 20px;" closed="true" buttons="#dlg-buttons">
		        <form id="fm" method="post">
			       ...
			       <div class="fitem">
			           <label style="white-space: nowrap;">资金池最高限额</label>
			           <input id="maxAmount" name="maxAmount" class="easyui-numberbox" required="true" missingMessage="请输入数字"/>
			       </div>
