		    ...
		    <table id="dg" fit="true" class="easyui-datagrid" title="" style="width:'1024px';height:auto" 
			    ...
			    <thead>
				    <tr>
				    	...
				    	<th data-options="field:'merchantName',width:200">所属出资方</th>
					    <th data-options="field:'ratio',width:200">分成比例</th>
		        ...
		        <form id="fm" method="post">
			       ...
			       <div class="fitem">
					   ...
					   <input id="merchantId" name="merchantId" class="easyui-combobox" 
					   		data-options="valueField:'id',textField:'merchantName',editable:false,url:'${pageContext.request.contextPath}/erp/investment/findAllMerchantToSelect'" required="true"/>
			       </div>
			       
			       <div class="fitem">
			           <label>分成比例</label>
			           <input id="ratio" name="ratio" class="easyui-validatebox" required="true" validType="rate"/>
			       </div>
