		...
		<script type="text/javascript">
	        ...
	        function detailHandler() {
	            ...
	            if (row) {
                    ...
                    $("#dg1").datagrid({
			        	url: '${pageContext.request.contextPath}/erp/investmentClearingDetail/findInvestmentClearingDetail'
			        });
    ...
    <body class="easyui-layout" data-options="fit:true,border:false">
		...
		<div data-options="region:'center',border:false">
		    ...
		    <table id="dg" fit="true" class="easyui-datagrid datagrid-body" title="" 
			    ...
			    toolbar: '#tb',
			    fitColumns:true,
			    url: '${pageContext.request.contextPath}/erp/investmentClearing/findInvestmentClearing',
			    ...
			    <thead>
				    <tr>
					    ...
					    <th data-options="field:'c',width:100">出资方</th>
					    ...
					    <th data-options="field:'clearingStatus',width:70,formatter:function(value,row){
					        if((row.clearingStatus=='11') || (row.clearingStatus=='10')) {
					        	return '未结算';
					        } else if(row.clearingStatus=='30') {
					        	return '已结算';
					        }
						}">结算状态</th>
